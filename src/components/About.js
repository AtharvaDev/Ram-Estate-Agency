    ...
    <div className="about">
      ...
      <section className="About__topBar">
        ...
        <div className="container mx-auto">
          <p>
            ...
            we’re here to empower you by making all things home simple,
      ...
      <section className="About__body">
        <div className="container mx-auto">
          ...
          <p>
            Ram Estate Agency is benchmark as an unparalleled Real Estate Agent
            in Thane, Maharashtra. With new improved realty solutions in each
            sphere, we have carved a niche for ourselves in the realty sector.
            Our approach is based on professionalism, trust and respect for the
            consumer The experience of transacting and having a practical
            approach at work in each segments of real estate has given Mukesh
            Estate Agency an edge over its competition.
          </p>
          <p>
            ...
            trusted. Our efforts have always been appreciated by clients, which
            motivates us to bring even better results for them.
          </p>
          <p>
            ...
            client retention rate bears testimony to our client-focused service
            approach.
          </p>
        </div>
      </section>
